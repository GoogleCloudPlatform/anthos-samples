...
# [START anthos_bm_gcp_bash_enable_api]
...
# [END anthos_bm_gcp_bash_enable_api]
...
# [START anthos_bm_gcp_bash_add_iam_role]
...
gcloud projects add-iam-policy-binding "$PROJECT_ID" \
  ...
  --no-user-output-enabled
# [END anthos_bm_gcp_bash_add_iam_role]
...
# [START anthos_bm_gcp_bash_vms_array]
...
# [END anthos_bm_gcp_bash_create_vm]
...
# [END anthos_bm_gcp_bash_check_ssh]
...
# [START anthos_bm_gcp_bash_add_vxlan]
...
sh get-docker.sh
EOF
# [END anthos_bm_gcp_bash_init_vm]
...
EOF
# [END anthos_bm_gcp_bash_add_ssh_keys]
...
EOF
# [END anthos_bm_gcp_bash_install_abm]
