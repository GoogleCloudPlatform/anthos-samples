...
terraform {
  required_version = ">= v0.12.0, < 1.2" # this line should not change during a release
  required_providers {
    google = {
  ...
  provider_meta "google" {
    # Anthos Bare metal version used in this release is 1.12.0
    # See
    ...
    module_name = "anthos-samples/terraform/anthos-bm-terraform:gce/v0.12.0"
  }
