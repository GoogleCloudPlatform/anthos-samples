...
variable "control_plane_hostname" {
  description = <<EOT
    The hostname that you have chosen to configure on control plane.
  EOT
  type        = string
}
...
variable "control_plane_ip" {
  description = <<EOT
    The IP address that you have chosen to configure on control plane.
  EOT
  type        = string
  validation {
    condition     = can(regex("^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$", var.ingress_vip))
...
variable "control_plane_netmask" {
  description = <<EOT
    The netmask that you have chosen to configure on control plane.
  EOT
  type        = string
}
...
variable "control_plane_gateway" {
  description = <<EOT
    The gateway that you have chosen to configure on control plane
  EOT
  type        = string
}
